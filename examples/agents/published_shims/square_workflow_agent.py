"""Published designer agent — Square Workflow Agent. Auto-generated; do not edit."""
...
_DEFINITION_ID = "def_c9bf03ff73d0"
...
def _load_class():
    ...
    return getattr(module, "SquareWorkflowAgentAgent")


SquareWorkflowAgentAgent = _load_class()
