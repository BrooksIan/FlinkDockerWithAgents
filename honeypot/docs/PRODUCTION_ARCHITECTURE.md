...
![Production topology](docs/images/production-topology.png)
...
![Hot path vs enrichment](../docs/images/production-hot-path-vs-enrichment.png)
...
```bash
# log-processor / synchronous Flink (default in honeypot/docker-compose.yml)
...
![Production components](../docs/images/production-components.png)
...
![Pipeline phases and Kafka topics](../docs/images/production-pipeline-phases.png)
