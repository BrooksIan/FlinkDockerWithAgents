...
from apemosyne.designer.store import DesignerStore, designer_db_path
from apemosyne.mcp.catalog import catalog_server, default_instance_id
...
def _all_catalog_servers(root=None):
    from apemosyne.mcp.catalog import load_mcp_catalog
