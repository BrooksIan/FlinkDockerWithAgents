"""Main CLI entry point for Ratatoskr."""
...
from ratatoskr.commands import agent_cmd, api_cmd, build, doctor_platform, kafka_cmd, process, stack, test_cmd, verify_cmd
from ratatoskr.commands.build import build_image
from ratatoskr.constants import DEFAULT_PROFILE, PROFILE_HELP, STARTUP_MODE_HELP
from ratatoskr.startup_modes import resolve_up_options
...
def main(
    ...
    """Ratatoskr — Flink Agents control plane."""
...
try:
    ...
    install_aliases()
    from ratatoskr.commands import (
        config_cmd,
        dashboard,
        demo,
        demo_ready_cmd,
