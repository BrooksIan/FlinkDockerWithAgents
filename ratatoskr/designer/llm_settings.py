...
from ratatoskr.designer.store import REACT_LLM_KEY, DesignerStore, designer_db_path
...
def _env_llm_settings() -> LlmSettings:
    endpoint = (
        os.environ.get("RATATOSKR_LLM_ENDPOINT_URL")
        or os.environ.get("CLOUDERA_AI_BASE_URL")
        or os.environ.get("OPENAI_BASE_URL")
        or ""
    ).strip().rstrip("/")
    model_id = (
        os.environ.get("RATATOSKR_LLM_MODEL_ID")
    ...
    api_key = (
        os.environ.get("RATATOSKR_LLM_API_KEY")
