"""Startup mode presets for ``ratatoskr up --mode``."""
...
from ratatoskr.manifests import STARTUP_MODES_FILE, ManifestError, manifests_dir
from ratatoskr.paths import honeypot_manifests_dir, project_root
