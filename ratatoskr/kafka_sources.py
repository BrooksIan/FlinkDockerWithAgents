...
_STATIC_TOPICS: dict[str, str] = {
    ...
    "cm.monitor.poll": "CM monitor poll triggers (continuous / Kafka-driven)",
    "cm.monitor.output": "CM monitor agent OutputEvents (optional sink)",
    "nifi.kafka.demo": "Shared NiFi←Kafka demo topic (ConsumeKafka lab flow)",
    "signals.correlate.output": "NiFi↔Kafka↔CM correlation incidents (workflow_signal_correlate)",
