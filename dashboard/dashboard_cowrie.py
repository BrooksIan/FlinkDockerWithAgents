...
def render_ai_agent_detection_dashboard(
    ...
    *,
    ...
    if not has_classified and not session_scores:
        ...
        st.code(
            "flink-cowrie utils simulate-attacks --e2e --scenario fast_llm_agent_session",
            language="bash",
        )
        st.code(
            "flink-cowrie utils simulate-attacks --e2e --scenario actor_classify_suite",
            language="bash",
        )
        st.caption(
            "Or run unit tests: `flink-cowrie test actor-classify` · "
    ...
    if session_scores:
        ...
        st.info(
            ...
            "Run `flink-cowrie utils simulate-attacks --e2e --scenario fast_llm_agent_session` "
