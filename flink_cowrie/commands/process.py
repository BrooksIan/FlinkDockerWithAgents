...
from flink_cowrie.docker_utils import project_root
...
def process_logs(
    log_file: str = typer.Option(
        None,
        "--log-file",
        help="Cowrie JSON log path (default: auto-detect)",
    ),
    ...
    """Watch Cowrie logs and update the dashboard (cowrie_log_processor.py)."""
    args: list[str] = []
    if log_file:
